...
import { extrair, provarExtrator, varrerCopy, type Achado } from './varredura.ts';

// O extrator mora em `scripts/varredura.ts`, compartilhado com a varredura de
// linguagem de média: as duas precisam da mesma resposta para "o que aqui é
// texto que a mãe lê?", e duas cópias divergem na primeira correção que só uma
// delas receber.
...
const achados: Achado[] = varrerCopy();
